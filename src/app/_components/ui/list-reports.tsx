    ...
    <div>
      ...
      <div className=" my-5 flex gap-3">
        {getReports.map((report, index) => (
          <Card className="w-4/12 rounded-lg" key={report.id + index}>
            <CardContent className="p-5">
              <div className="">
                <div className="mb-5 flex items-center justify-between">
                  ...
                  <div className="flex h-[82px] w-[94px] flex-col items-center justify-center gap-2 rounded-lg bg-rose-200 p-3 text-red-500">
